...
public class DialogEditNameFragment extends DialogFragment {

    private EditText userInput;

    public static DialogEditNameFragment newInstance(String title) {
        DialogEditNameFragment frag = new DialogEditNameFragment();
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        userInput.setText(DataManager.getInstance().getUserLogged().getName());
    ...
    private void saveInformation() {
        DataManager.getInstance().getUserLogged().setName(userInput.getText().toString());
